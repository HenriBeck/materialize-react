...
(0, _ava2.default)('should render a button and should have an Icon inside', function (t) {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_iconButton2.default, { icon: 'github' }));
...
(0, _ava2.default)('should have aria-disabled and tabIndex of -1 when disabled', function (t) {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_iconButton2.default, {
    disabled: true,
    icon: 'github'
  }));
...
(0, _ava2.default)('should add focus to the ripple when the component get\'s focused', function (t) {
...
(0, _ava2.default)('should only call the onPress handler when the keyCode is specified and valid', function (t) {
  ...
  t.plan(_iconButton2.default.keyCodes.length);

  _iconButton2.default.keyCodes.forEach(function (keyCode, index) {
...
(0, _ava2.default)('should not call the onPress handler again if the keyUp handler hasn\'t been called', function (t) {
  ...
  var keyCode = _iconButton2.default.keyCodes[0];
