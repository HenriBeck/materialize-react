...
(0, _ava2.default)('check if the elevation is computed correctly', function (t) {
...
(0, _ava2.default)('should compute the background color correctly', function (t) {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_button2.default, null));
  var instance = wrapper.instance();
...
(0, _ava2.default)('should work then no handlers are passed', function (t) {
  var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_button2.default, null));
