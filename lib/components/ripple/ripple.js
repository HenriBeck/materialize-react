...
var Ripple = function (_PureComponent) {
  ...
  function Ripple() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Ripple.__proto__ || Object.getPrototypeOf(Ripple)).call.apply(_ref, [this].concat(args))), _this), _this.waves = {}, _this.isTouchEvent = false, _this.handleMouseDown = function (ev) {
