...
(0, _ava2.default)('should not update the opacity of the spinner and only add the new styles', function (t) {
  ...
  var div = wrapper.find('.spinner').first();

  t.true(div.prop('className').includes('something'));
});

(0, _ava2.default)('should remove and add the active class if necessary', function (t) {
  var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_spinner.Spinner, {
